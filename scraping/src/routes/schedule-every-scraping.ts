...
import { ScrapingEverySchedulePublisher } from "../events/publishers/scraping-every-scheduled-publisher";
...
router.post(
  "/api/scraping/schedule-every/:scraper_id",
  requireAuth,
  [
    body("schedule_for")
      .not()
      ...
      .isNumeric()
      .withMessage("Schedule for should be number(in minutes)"),
  ],
  validateRequest,
  async (req: Request, res: Response) => {
    ...
    new ScrapingEverySchedulePublisher(natsWrapper.client).publish({
...
export { router as scheduleEveryScrapingRouter };
