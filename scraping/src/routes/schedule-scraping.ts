...
import { ScrapingSchedulePublisher } from "../events/publishers/scraping-scheduled-publisher";
...
router.post(
  "/api/scraping/schedule/:scraper_id",
  requireAuth,
  [
    body("schedule_for")
      .not()
  ...
  async (req: Request, res: Response) => {
    ...
    new ScrapingSchedulePublisher(natsWrapper.client).publish({
...
export { router as scheduleScrapingRouter };
